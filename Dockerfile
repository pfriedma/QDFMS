...
cd ../qdfms_web && mix local.rebar --force && mkdir ./priv/static/assets && cp ./assets/vendor/html5-qrcode.min.js ./priv/static/assets/html5-qrcode.min.js && mix phx.gen.cert
